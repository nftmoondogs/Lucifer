...
export default function Navbar() {
 ...
 <div className="flex items-center">
          ...
          <a href="/" className="flex items-center">
            <img src="https://i.ibb.co/mbDpJsz/optimized.gif" alt="WOOF Logo" className="h-12" />
          </a>
          <h2 className="font-courier-bold text-2xl mr-3">$LUCIFER</h2>
        </div>
        <div className="flex items-center">
          {/* Social Icons */}
          <a href="https://twitter.com/lucifersoltoken" target="_blank" rel="noopener noreferrer" className="text-white px-3">
          ...
          <a href="https://t.me/lucifersoltoken" target="_blank" rel="noopener noreferrer" className="text-white px-3">
